            ...
            >
              ...
              {cameraError ? (
                ...
                <div className="flex flex-col gap-6">
                  <div className="relative aspect-[3/4] xs:aspect-[9/14] sm:aspect-[12/10] md:aspect-video w-full max-w-6xl mx-auto rounded-2xl md:rounded-3xl overflow-hidden bg-black shadow-[0_0_50px_rgba(0,0,0,0.8)] flex flex-col justify-center items-center group">
