...
import { Upload, FileImage, Loader2, Sparkles, CheckCircle2, FolderOpen } from "lucide-react";
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3.5">
            ...
            <button
              ...
              className="group flex items-center justify-center gap-3.5 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white p-4 rounded-2xl font-bold text-sm tracking-wide font-mono active:scale-98 transition duration-200 shadow-lg shadow-indigo-500/10 border border-white/10 cursor-pointer uppercase"
            >
              <FolderOpen className="w-5 h-5 text-indigo-100 group-hover:scale-110 transition duration-300" />
              Escolher da Galeria / Tirar Foto
            </button>
          </div>
        </div>
      )}
